...
public class VendingMachineImpl implements VendingMachine {
  ...
  private Item collectItem() throws NotSufficientChangeException, NotFullPaidException{
    ...
    long remaingBalance = currentItem.getPrice() - currentBalance;
    throw new NotFullPaidException("Price not full paid, remining:", remainingBalance);
          ...
          while(balance >0){
            if(balance >= Coin.QUARTER.getDenomination() && cashInventory.hasItem(Coin.QUARTER)) {
              ...
              continue;
                ...
                throw new NotSufficientChangeException("NotSufficientChange Error! Please try another product");
            }
          }
        }
  ...
  private boolean hasSufficientChangeForAmount(long amount){
    ...
    try{
      getChange(amount);
    }catch(NotSufficientChangeException notSufficientChangeException){
